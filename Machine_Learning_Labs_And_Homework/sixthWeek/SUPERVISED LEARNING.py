...
data = pd.read_csv(r'C:\Users\engab\Desktop\python\Untitled Folder\column_2C_weka.csv')
...
ridge = Ridge(alpha=0.1)  # No need for normalize parameter
...
lasso = Lasso(alpha=0.1)  # No need for normalize parameter
